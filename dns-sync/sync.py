...
# Per-instance passwords: PIHOLE_PASSWORD_<IP_WITH_UNDERSCORES> (e.g. PIHOLE_PASSWORD_192_0_2_100)
...
examples:
  ...
  PIHOLE_PASSWORD=secret DRY_RUN=true python3 sync.py --rollback backups/192.0.2.100_2026-02-19T221000Z.json

  # Rollback for real
  PIHOLE_PASSWORD=secret python3 sync.py --rollback backups/192.0.2.100_2026-02-19T221000Z.json
""",
    )
    parser.add_argument(
        "--rollback",
